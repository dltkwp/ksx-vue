            ...
            <div class="col-lg-12">
              <div class="tabs-container">
                <ul class="nav nav-tabs">
                  ...
                  <li><a data-toggle="tab" href="#tab-2"> 修改密码</a></li>
                </ul>
                    ...
                    <div class="panel-body">
                      <form method="get" class="form-horizontal">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="输入微信后方便供应商与分销商之间转账（非必填）">
                          </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="输入支付宝后方便供应商与分销商之间转账（非必填）">
                          </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
...
export default {
  ...
  methods:{
    ...
    updatePassword(){
      ...
      _this.PUSH_LOADING();
      _this.$axios.post('updatePassword',{
